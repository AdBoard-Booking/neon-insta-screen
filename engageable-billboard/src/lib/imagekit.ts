...
export async function createFramedImage(imageUrl: string, name: string, instagramHandle?: string) {
  try {
    ...
    // Create transformation URL for framed image
    const transformation = [
      ...
      // Add frame overlay (you'll need to upload a frame image to ImageKit)
      {
        overlayImage: 'billboard-frame', // Replace with your actual frame image path
        overlayWidth: 700,
        overlayHeight: 700,
        overlayX: 'center',
        overlayY: 'center',
      ...
      // Add text overlay for name and Instagram
      {
        overlayText: textOverlay,
        overlayTextFontSize: 24,
        overlayTextFontFamily: 'Arial',
        overlayTextColor: 'FFFFFF',
        overlayTextBackground: '00000080', // Semi-transparent black
      ...
      // Add hashtag
      {
        overlayText: '#MyBillboardMoment',
        overlayTextFontSize: 18,
        overlayTextFontFamily: 'Arial',
        overlayTextColor: 'FFD700', // Gold color
        overlayTextBackground: '00000080',
        overlayTextPadding: 8,
        overlayX: 'center',
        overlayY: 'bottom',
        overlayYOffset: 10,
      }
